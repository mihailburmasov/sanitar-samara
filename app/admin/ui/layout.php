...
<title>Управление сайтом — SANITAR</title>
...
<div class="app">
  <aside class="side" id="side">
    <a class="side__logo" href="#/"><img src="<?= esc(S::$base) ?>/images/logo.webp" width="120" height="48" alt=""><span><small>управление сайтом</small></span></a>
