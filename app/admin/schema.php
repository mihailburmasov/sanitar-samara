...
function admin_sections(): array
{
    ...
    $S['company'] = ['title' => 'Компания и контакты', 'group' => 'Общее', 'url' => '/kontakty/', 'fields' => [
        ...
        f('url', $co . 'telegramChat', 'Telegram для кнопки в шапке', 'Личный чат по номеру: https://t.me/+79272607367. Пусто — кнопка ведёт в канал'),
        ...
        head('Реквизиты', 'Показываются в подвале и в политике конфиденциальности. Пусто — жёлтая пометка «заполнить».'),
