...
<p>Мы не продаём и не передаём ваши данные третьим лицам в маркетинговых целях. Заявка отправляется на электронную почту оператора. Данные могут обрабатываться хостинг-провайдером сайта' . ($ym ? ' и сервисом Яндекс.Метрика (ООО «Яндекс»)' : '') . ' в объёме, необходимом для предоставления сервиса.</p>
<h2>7. Ваши права</h2>
...
<p>Отправляя форму на сайте, я свободно, своей волей и в своём интересе даю оператору — ' . val('ЮР_НАЗВАНИЕ', $C['legal']['name']) . ' (ИНН ' . val('ИНН', $C['legal']['inn']) . ') — согласие на обработку моих персональных данных (имя, номер телефона, адрес или район, тип объекта, комментарий, удобное время звонка) в целях обратной связи, расчёта стоимости и оказания услуг. Согласие действует до достижения целей обработки или до его отзыва. Согласие можно отозвать, направив обращение на ' . $mail . '.</p>
