...
function page_politika(): array
{
    ...
    $op = val('ЮР_НАЗВАНИЕ', $C['legal']['name']) . ' (ИНН ' . val('ИНН', $C['legal']['inn']) . ', ОГРН ' . val('ОГРН', $C['legal']['ogrn']) . '), адрес: ' . val('АДРЕС', $C['address']);
